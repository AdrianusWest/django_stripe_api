...
from stripe_api_payment.payments.forms import OrderForm
from stripe_api_payment.payments.models import Item, Order
...
class StripeIntentView(View):
    """PaymentIntent - загрузка формы оплаты на страницу."""
